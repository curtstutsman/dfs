...
protected:
    ...
    static void SetUpTestSuite() {
        ...
        server = new DFSServiceImpl(kServerMnt, kAddr, 2);
...
DFSServiceImpl* ServiceTestFixture::server    = nullptr;
ClientNode*  ServiceTestFixture::client = nullptr;

// ── Store ────────────────────────────────────────────────────────────────────

TEST_F(ServiceTestFixture, Store_NewFile_Succeeds) {
...
TEST_F(ServiceTestFixture, Store_UnchangedFile_ReturnsAlreadyExists) {
...
TEST_F(ServiceTestFixture, Store_LargeFile_Succeeds) {
...
TEST_F(ServiceTestFixture, Fetch_ExistingFile_Succeeds) {
...
TEST_F(ServiceTestFixture, Fetch_NonexistentFile_ReturnsNotFound) {
    EXPECT_EQ(client->Fetch("missing.txt"), grpc::StatusCode::NOT_FOUND);
}

TEST_F(ServiceTestFixture, Fetch_UnchangedFile_ReturnsAlreadyExists) {
...
TEST_F(ServiceTestFixture, Delete_ExistingFile_Succeeds) {
...
TEST_F(ServiceTestFixture, Delete_NonexistentFile_ReturnsNotFound) {
    EXPECT_EQ(client->Delete("ghost.txt"), grpc::StatusCode::NOT_FOUND);
}

// ── List ─────────────────────────────────────────────────────────────────────

TEST_F(ServiceTestFixture, List_EmptyServer_ReturnsOk) {
    std::map<std::string, int64_t> files;
    EXPECT_EQ(client->List(&files), grpc::StatusCode::OK);
    EXPECT_TRUE(files.empty());
}

TEST_F(ServiceTestFixture, List_WithFiles_ReturnsAllFilenames) {
...
TEST_F(ServiceTestFixture, WriteLock_Contention_SecondClientBlocked) {
